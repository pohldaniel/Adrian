...
SceneComposer::SceneComposer()
{
	...
	if (enable_shaders) {
		if(GLEW_ARB_vertex_program && GLEW_ARB_fragment_program && GL_EXT_framebuffer_object)
		{
			...
			//m_PostProcessShader = new PPShaderProgram((char *)"vs.txt", (char *)"bloom.txt"); //post proc shader.
			m_PostProcessShader = new PPShaderProgram((char *)"vs.txt", (char *)"toonps.txt"); //post proc shader.
			...
			m_RenderPass.push_back(new RenderPass(m_PostProcessShader));
